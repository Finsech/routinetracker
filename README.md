...
Добавлен первый слой нативного трекинга: Tauri-команды запуска, остановки и статуса, polling активного окна Windows, определение имени процесса и заголовка окна, базовый учет простоя после 10 минут без ввода, фильтрация активных интервалов короче 5 секунд, запись завершенных активных и idle-интервалов в SQLite. В боковой панели есть кнопка запуска и остановки трекинга, live-статус текущей активности и счетчик времени без ввода; в browser preview они работают через мок-режим.
