...
### EN
FocusFlow is a local-first time tracker designed to explain more than “6 hours in a browser.” It captures real window and site activity, then uses a local LLM to regroup the day into meaningful flows and projects. The result is a project-aware view of where time actually went.
